...
//public static long ConvertStringToLong(String nbOfBlocks)
//the function Convert String to an Long value

//ConvertLongToDecFormatString
//input : Long 2047
//output : String "2047"
...
public class Helper {
	...
	public static String FormatStringAddressStart(String stringToFormat,
		...
		// int iAddresStartMax =
		// ConvertStringToInt(StringForceDigit(ma.getMemorySize(),4));
	...
	// * Example : FormatStringAddressStart ("FFFF") -> returns "07FF"
	// ***********************************************************************/
	public static String FormatStringNbBlock(String stringToformat,
			String sAddressStart, DataDevice ma) {
		...
		int iAddresStartMax = ConvertStringToInt(StringForceDigit(
				ma.getMemorySize(), 4));
		...
		/*
		 * else if(iNbBlockToRead > iAddresStartMax) { iNbBlockToRead =
		 * iAddresStartMax +1; }
		 */
	...
	// ***********************************************************************/
	public static String FormatStringNbBlockInteger(String stringToformat,
			String sAddressStart, DataDevice ma) {
		String sNbBlockToRead = stringToformat;
		sNbBlockToRead = StringForceDigit(sNbBlockToRead, 4);
	...
	// * Example : ConvertIntToHexFormatString (2047) -> returns "7FF"
	// ***********************************************************************/
	public static String ConvertLongToDecFormatString(long iNumberToConvert) {
		String sConvertedNumber = "";
		String sConvertedNumber2 = "";

		while(iNumberToConvert>0){
			sConvertedNumber+=String.valueOf((iNumberToConvert%10));
			iNumberToConvert/=10;
		}
		while(sConvertedNumber.length()>0){
			sConvertedNumber2+=sConvertedNumber.substring(sConvertedNumber.length()-1);
			sConvertedNumber=sConvertedNumber.substring(0, sConvertedNumber.length()-1);
		}
		while(sConvertedNumber2.length()<15){
			sConvertedNumber2="0"+sConvertedNumber2;
		}
		return sConvertedNumber2;
	}
	// ***********************************************************************/
	// * the function Convert String to an Long value
	// ***********************************************************************/
	public static long ConvertStringToLong(String nbOfBlocks) {
		...
		while (nbOfBlocks.length() < 16) {
			nbOfBlocks="0"+nbOfBlocks;
		}
		String msb1 = nbOfBlocks.substring(0, 2);
		String lsb1 = nbOfBlocks.substring(2, 4);
		String msb2 = nbOfBlocks.substring(4, 6);
		String lsb2 = nbOfBlocks.substring(6, 8);
		String msb3 = nbOfBlocks.substring(8, 10);
		String lsb3 = nbOfBlocks.substring(10, 12);
		String msb4 = nbOfBlocks.substring(12, 14);
		String lsb4 = nbOfBlocks.substring(14, 16);

		count = Integer.parseInt(msb1, 16);
		count<<=8;
		count += (Integer.parseInt(lsb1, 16));
		count<<=8;
		count += Integer.parseInt(msb2, 16);
		count<<=8;
		count += (Integer.parseInt(lsb2, 16));
		count<<=8;
		count += Integer.parseInt(msb3, 16);
		count<<=8;
		count += (Integer.parseInt(lsb3, 16));
		count<<=8;
		count += Integer.parseInt(msb4, 16);
		count<<=8;
		count += (Integer.parseInt(lsb4, 16));
